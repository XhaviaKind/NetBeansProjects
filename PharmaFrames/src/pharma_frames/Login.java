...
//        JOptionPane.showMessageDialog(rootPane, reg.getRegisteredList());
        ...
        String passw = loginPasswordField.getText();
        
        if(username.equals(uname) && passw.equals(pass)){
            JOptionPane.showMessageDialog(rootPane, "YOU ARE SUCCESFULLY LOGGED IN\n" + " " +  uname + " " + pass);
